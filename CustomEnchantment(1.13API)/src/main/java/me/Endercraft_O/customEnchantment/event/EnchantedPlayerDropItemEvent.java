...
public class EnchantedPlayerDropItemEvent extends Event {

	private PlayerDropItemEvent event;
	private List<CustomEnchantmentValue> enchantment;
	
	public EnchantedPlayerDropItemEvent(PlayerDropItemEvent event, List<CustomEnchantmentValue> enchantment) {
		this.event = event;
