...
public class ItemEnchanter {
	...
	{
		if((cev.getEnchantment().getApplicable() == null || cev.getEnchantment().getApplicable().isEmpty() || cev.getEnchantment().getApplicable().contains(item.getType())) && !hasCustomEnchantments(item, cev.getEnchantment().getConflicts()))
		{
